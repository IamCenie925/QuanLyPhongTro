...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        //thêm dịch vụ CookieService để quản lý cookie:
        services.AddScoped<PhongTro3.Blazor.Server.Services.CookieService>();

        services.AddScoped<CircuitHandler, CircuitHandlerProxy>();
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<PhongTro3BlazorApplication>();
            ...
            builder.Modules
                ...
                .AddViewVariants()
                .Add<PhongTro3.Module.PhongTro3Module>()
                .Add<PhongTro3BlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(PhongTro3.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(PhongTro3.Module.BusinessObjects.ApplicationUserLoginInfo);
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "PhongTro3 API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the PhongTro3.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "PhongTro3 WebApi v1");
            });
        }
        else {
